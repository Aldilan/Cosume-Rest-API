		...
		<div class="table-responsive">
			<div class="table-wrapper">
				...
				@if(session('messageF'))
					...
					<strong>{{session('messageF')}}!</strong>
					<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
					</div>
				@endif
                    ...
                    @foreach($datas as $data)
						<tr>
                            ...
                            <td align="center">
                                ...
                                @method('DELETE')
                                @csrf
                                    <a href="{{ 'users/'.$data['id'] }}" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> |
				...
				<div class="clearfix">
					...
					<ul class="pagination">
						<li class="page-item {{request('page') == 1 ? 'disabled' : ''}}"><a href="?page={{request('page')? request('page')-1 : '1'}}">Previous</a></li>
